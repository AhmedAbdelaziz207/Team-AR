...
abstract class RegisterSuccess implements RegisterState {
  const factory RegisterSuccess(final RegisterResponse data) =
...
class _$RegisterFailureImpl implements RegisterFailure {
  const _$RegisterFailureImpl(this.errorModel);
  ...
  @override
  String toString() {
    return 'RegisterState.failure(errorModel: $errorModel)';
  }
...
abstract class RegisterFailure implements RegisterState {
  const factory RegisterFailure(final ApiErrorModel errorModel) =
